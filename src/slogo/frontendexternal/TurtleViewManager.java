...
//=======
  ...
  public SequentialTransition correctPositions() {
    ...
    for (Integer k: turtleStatusMap.keySet()) {
      ...
      TurtleStatus tsAdjusted = new TurtleStatus(tsFinal.getID(), tsFinal.getX(), tsFinal.getY()-0.0001, tsFinal.getBearing() - 0.0001, tsFinal.getTrail(), tsFinal.getVisible(), tsFinal.getPenDown());
